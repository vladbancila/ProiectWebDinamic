...
<body>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span
					...
					<ul class="dropdown-menu">
						...
						<li role="separator" class="divider"></li>
						<li class="active"><a href="accesorii"><span class="glyphicon glyphicon-sunglasses"></span> Accesorii</a></li>
					</ul></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h1>
					<span class="alert alert-danger">Lista Completa de Accesorii</span>
				</h1>
				<h1></h1>
			</div>
		</div>
		<div class="row">
			<c:forEach items="${accesorii}" var="acc">
				<div class="col-sm-4">
					<div class="thumbnail">
						<img class="imagine" src="${acc.cale_poza}">
						<div class="caption">
							<h3 class="alert alert-success">${acc.nume_prod}</h3>
							<p class="alert alert-info">${acc.descriere}</p>
							<p class="alert alert-info">Pret intreg: ${acc.pret} Euro</p>
							<p class="alert alert-info">Pret abonament: ${acc.pret_redus} Euro</p>
							...
							<!-- <form action="adaugaInCos" method="post">
								<input type="hidden" name="id" value="${tel.id}"> <input type="submit" value="Adauga in cos de cumparaturi">
							</form> -->
							<form class="form-inline centru" action="adaugaInCosAccesorii" method="post">
								<button type="submit" name="id" value="${acc.id}" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Adauga in cos !">
